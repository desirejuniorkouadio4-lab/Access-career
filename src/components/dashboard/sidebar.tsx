...
import {
  ...
  LogOut, ChevronLeft, GraduationCap, PlusCircle, Users,
  BarChart3, FolderOpen, Shield, X,
} from "lucide-react"
...
export default function Sidebar({ user, open, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 h-full w-[260px] bg-ink text-white flex flex-col z-50 transition-transform duration-300
      ...
      >
        ...
        <div className="flex items-center justify-between px-5 py-5 border-b border-zinc-800">
          <Link href="/" className="flex items-center gap-2">
            <div className="w-8 h-8 bg-violet-600 rounded-lg flex items-center justify-center font-extrabold text-sm">
              A
            </div>
        ...
        <div className="px-5 py-4 border-b border-zinc-800">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 bg-violet-700 rounded-full flex items-center justify-center text-sm font-bold">
